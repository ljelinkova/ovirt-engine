 ...
 */
public abstract class AbstractModelBoundFormWidget<T, M extends EntityModel<T>> extends Composite implements Editor<T>, HasElementId, HasCleanup {

    private final ModelProvider<T, M> modelProvider;
    private final GeneralFormPanel formPanel;

    protected final FormBuilder formBuilder;

    public AbstractModelBoundFormWidget(ModelProvider<T, M> modelProvider, int numOfColumns, int numOfRows) {
     ...
     */
    protected abstract void doEdit(M model);
